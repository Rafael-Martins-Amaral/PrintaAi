...
A aplicação também permite consultar os pedidos realizados e utilizar uma API pública de CEP para facilitar o preenchimento do endereço durante o cadastro do pedido.
...
- **API Pública**
  - **ViaCEP** - API pública utilizada para consulta de endereços a partir do CEP informado pelo cliente.
