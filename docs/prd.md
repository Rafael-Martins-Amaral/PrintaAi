...
## 2. Atores do Sistema
- **Visitante**: Usuário que acessa a aplicação e pode criar uma conta ou realizar login.
- **Cliente**: Usuário autenticado que pode acessar o catálogo e realizar pedidos.
...
## 🛒 Épico 3: Cadastro de Pedidos
 ...
 Como um Cliente, quero preencher meus dados e selecionar uma camiseta para registrar um novo pedido.
 Critérios de Aceitação:
